            ...
            <div class="card-body">
              ...
              <table class="table table-striped" id="vendor-table">
                ...
                <tbody id="tableShowvendor">
                  <?php
                  $receive = $access->select("SELECT * FROM vendor");
                  if ($receive !== 'failed') {
                  ...
                  ?>
                      ...
                      <td><?php echo  $data['vendorID']; ?></td>
                        ...
                        <td><?php echo  $data['vendor_description']; ?></td>
                        <td><a onclick="deleteData(this)" data-del_Id="<?php echo  $data['vendorID']; ?>" class="btn btn-danger">Delete</a></td>
                        <td><a href="form-vendor.php?vendorID=<?php echo $data['vendorID']; ?>" class="btn btn-primary">Update</a></td>
                      </tr>
                  <?php
                    }
                  }
